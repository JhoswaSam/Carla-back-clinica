...
export class Init1682656757626 implements MigrationInterface {
    name = 'Init1682656757626'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`medico\` (\`create_ad\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`update_ad\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id_medico\` int NOT NULL AUTO_INCREMENT, \`nombre\` varchar(255) NOT NULL, \`apellido\` varchar(255) NOT NULL, \`fecha_nacimiento\` datetime NOT NULL, \`genero\` enum ('M', 'F') NOT NULL, \`direccion\` varchar(255) NOT NULL, \`ciudad\` varchar(255) NOT NULL, \`pais\` varchar(255) NOT NULL, \`telefono\` varchar(255) NOT NULL, \`correo_electronico\` varchar(255) NOT NULL, \`especialidad\` varchar(255) NOT NULL, \`numero_colegiatura\` varchar(255) NOT NULL, \`descripcion_profecional\` varchar(255) NOT NULL, PRIMARY KEY (\`id_medico\`)) ENGINE=InnoDB`);
